  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      document.getElementById('downloadPdf').addEventListener('click', () => {
        ...
        let rangeText = '';
        if (start && end) {
          rangeText = `Transactions from ${start} to ${end}`;
        } else if (start) {
          rangeText = `Transactions from ${start} onwards`;
        } else if (end) {
          rangeText = `Transactions up to ${end}`;
        } else {
          rangeText = `All Transactions`;
        }
        ...
        // send data to cloudfare library
